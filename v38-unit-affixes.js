(() => {
  ...
  const excludeMoney=/\b(mpg|rpm|cpm|percent|percentage|%|weight|lb|gvwr|gcwr|gawr|payload|mile|miles|mileage|gallon|gallons|gal)\b/i;
  ...
  const unitText={money:'$',weight:'lb',miles:'mi',gallons:'gal'};
  ...
  style.textContent=`
    ...
    .flt-unit-weight>.flt-unit-affix,.flt-unit-miles>.flt-unit-affix,.flt-unit-gallons>.flt-unit-affix{padding-right:11px}
