(() => {
  ...
  style.textContent=`
    ...
    @media(max-width:980px){
      ...
      #v38-core-load-decision-fields .v38-core-grid{grid-template-columns:minmax(180px,1fr) minmax(160px,1fr)!important;column-gap:18px!important;row-gap:10px!important}
    }
