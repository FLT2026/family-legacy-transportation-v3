...
const element=()=>({innerHTML:'',textContent:'',className:'',childNodes:[{textContent:''}],appendChild(child){elements.set(child.id,child);}});
const finance=element(),test=element(),header=element(),footer=element(),clock={parentElement:footer},testTitle=element(),testNav=element();
